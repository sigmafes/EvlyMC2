// Copiado de src/mob-pathfinding.ts el 2026-09-14 - ver world-server/README
// (o el mensaje del commit que introdujo esta carpeta) para el criterio de
// qué se copia vs qué sigue compartido con singleplayer. Cambios acá NO se
// reflejan automáticamente en src/mob-pathfinding.ts, y viceversa.
