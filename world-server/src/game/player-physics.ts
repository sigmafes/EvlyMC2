// Copiado de src/player-physics.ts el 2026-09-14 - ver world-server/src/game/README.md
// para el criterio de qué se copia vs qué sigue compartido con singleplayer.
// Cambios acá NO se reflejan automáticamente en src/player-physics.ts, y
// viceversa - acordate de aplicar a mano cualquier arreglo de física que
// también deba valer en singleplayer (y viceversa).
//
// WorldBounds se define acá mismo (en vez de importar ./world) porque solo
// hace falta el tipo, no la clase World completa (que trae ChunkManager/
// IndexedDB/etc, nada de lo cual aplica del lado del servidor).
