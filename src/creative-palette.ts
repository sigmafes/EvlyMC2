...
export const BLOCK_CATALOG: InventorySlot[] = [
  ...
  { id: BlockId.WOOL, name: 'Wool', sideTexture: 'blocks/wool.png', topTexture: 'blocks/wool.png' },
  { id: BlockId.OAK_STAIRS, name: 'Oak Stairs', sideTexture: 'blocks/oak_planks.png', topTexture: 'blocks/oak_planks.png' },
  { id: BlockId.OAK_SLAB, name: 'Oak Slab', sideTexture: 'blocks/oak_planks.png', topTexture: 'blocks/oak_planks.png' },
  { id: BlockId.COBBLESTONE_STAIRS, name: 'Cobblestone Stairs', sideTexture: 'blocks/cobblestone.png', topTexture: 'blocks/cobblestone.png' },
  { id: BlockId.COBBLESTONE_SLAB, name: 'Cobblestone Slab', sideTexture: 'blocks/cobblestone.png', topTexture: 'blocks/cobblestone.png' },
  { id: BlockId.OAK_FENCE, name: 'Oak Fence', sideTexture: 'blocks/oak_planks.png', topTexture: 'blocks/oak_planks.png' },
  { id: BlockId.OAK_FENCE_GATE, name: 'Oak Fence Gate', sideTexture: 'blocks/oak_planks.png', topTexture: 'blocks/oak_planks.png' },
  { id: BlockId.COBBLESTONE_WALL, name: 'Cobblestone Wall', sideTexture: 'blocks/cobblestone.png', topTexture: 'blocks/cobblestone.png' },
  { id: BlockId.IRON_BLOCK, name: 'Block of Iron', sideTexture: 'blocks/iron_block.png', topTexture: 'blocks/iron_block.png' },
  { id: BlockId.GOLD_BLOCK, name: 'Block of Gold', sideTexture: 'blocks/gold_block.png', topTexture: 'blocks/gold_block.png' },
  { id: BlockId.DIAMOND_BLOCK, name: 'Block of Diamond', sideTexture: 'blocks/diamond_block.png', topTexture: 'blocks/diamond_block.png' },
  { id: BlockId.LAPIS_BLOCK, name: 'Block of Lapis Lazuli', sideTexture: 'blocks/lapis_block.png', topTexture: 'blocks/lapis_block.png' },
